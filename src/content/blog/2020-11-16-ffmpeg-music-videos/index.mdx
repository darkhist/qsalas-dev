...
date: "2020-11-16"
time: "09:07:53"
description: "A tutorial on using the ffmpeg command-line utility to merge audio and video files"
---
...
```bash
ffmpeg \ -i song.mp3 \ -stream_loop -1 \ -i gif.gif \ -codec:v libx264 \
-preset slow \ -tune animation \ -codec:a aac \ -pix_fmt yuv420p \ -shortest \
mv.mp4
```
